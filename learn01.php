  ...
  <body>
    ...
    <div class="container marketing">
      ...
      <div class="row featurette" id="">
        ...
        <div class="col-md-5 ">
          <img class="featurette-image img-responsive center-block" src="images/tongji.jpg" alt="Generic placeholder image" width="300px">
        </div>
        <div class="col-md-7 ">
          <button style="float: right" class="btn btn-success">more</button>
          <ul style="float: left" class="nav">
            ...
            <li>
          <a href="http://www.mrdubo.com" style="font-size: 25px;">test</a>
            </li>
            <img src="images/bo.png" style="width: 30px;float: left">
            <li>
          <a href="http://www.mrdubo.com" style="font-size: 25px"> 高数难啊啊啊啊啊</a>
            </li>
            <li>
          <a href="http://www.mrdubo.com" style="font-size: 25px"> test</a>
            </li>
      ...
      <div class="row featurette">
        <div class="col-md-5">
          <img class="featurette-image img-responsive center-block" src="images/c.jpg" alt="Generic placeholder image" width="40%">
        </div>
        <div class="col-md-7">
          <button style="float: right" class="btn btn-success">more</button>
          <ul style="float: left">
            <li>
              <a href="http://www.mrdubo.com" style="font-size: 25px"> </a>
            </li>
            <li>
              <a href="http://www.mrdubo.com" style="font-size: 25px"> test</a>
            </li>
      ...
      <div class="row featurette">
        ...
        <div class="col-md-5 col-md-pull-7">
          <img class="featurette-image img-responsive center-block" src="images/vs.jpg" alt="Generic placeholder image" >
        </div>
      </div>
