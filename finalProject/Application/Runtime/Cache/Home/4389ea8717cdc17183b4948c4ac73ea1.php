                            ...
                            <div id="head" class="img-responsive" alt="Responsive image">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content" style="color: #3c3c3c">
                                        ...
                                        <div>
                                            <form method="post" action="/finalProject/index.php/Home/Index/courseUpd">
                                                <div class="form-group" style="margin-left: 150px; display: none">
                                                    <label for="id_upd">编号</label>
                                                    <input type="text" class="form-control" id="id_upd" name="id" value="<?php echo ($data["id"]); ?>"
                                                           style="width: 60%">
                                                </div>
                                                <div class="form-group" style="margin-left: 150px  ">
                                                    <label for="name_upd">课程名称</label>
                                                    <input type="text" class="form-control" id="name_upd" name="name" value="<?php echo ($data["name"]); ?>"
                                                           style="width: 60%">
                                                </div>
                                                <div class="form-group" style="margin-left: 150px">
                                                    <label for="time_upd">课程时间</label>
                                                    <input type="text" class="form-control" id="time_upd" name="time" value="<?php echo ($data["time"]); ?>"
                                                           style="width: 60%">
                                                </div>
                                                <div class="form-group" style="margin-left: 150px">
                                                    <label for="img_upd">课程图片</label>
                                                    <input type="text" class="form-control" id="img_upd" name="img" value="<?php echo ($data["img"]); ?>"
                                                           style="width: 60%">
                                                </div>
                                                <div class="form-group" style="margin-left: 150px">
                                                    <label for="title_upd">简介标题</label>
                                                    <input type="text" class="form-control" id="title_upd" name="title" value="<?php echo ($data["title"]); ?>"
                                                           style="width: 60%">
                                                </div>
                                                <div class="form-group" style="margin-left: 150px">
                                                    <label for="message_upd">简介课程</label>
...
<div class="modal fade" id="myModal1" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="color: #3c3c3c">
            ...
            <div>
                <form method="post" action="/finalProject/index.php/Home/Index/courseAdd">
                    <div class="form-group" style="margin-left: 150px">
