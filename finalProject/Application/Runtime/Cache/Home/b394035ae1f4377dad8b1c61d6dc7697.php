...
<div class="row">
    <div class="leftmenu col-md-3">
        <div class="list-group">
            <a href="#" class="list-group-item active" onclick="line()">查看航线=班信息</a>
                            ...
                            <div id="head" class="img-responsive" alt="Responsive image">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content" style="color: #3c3c3c">
                                        ...
                                        <div>
                                            <form method="post" action="/airadmin/index.php/Home/Index/flightupd">
                                                ...
                                                <div class="form-group" style="margin-left: 150px">
                                                    ...
                                                    <input type="text" class="form-control" id="startAd" name="startAd" value="<?php echo ($data["startad"]); ?>"
                                                           style="width: 60%">
                                                </div>
                                                <div class="form-group" style="margin-left: 150px">
                                                    <label for="finAd">目的地</label>
                                                    <input type="text" class="form-control" id="finAd" name="finAd" value="<?php echo ($data["finad"]); ?>"
                                                           style="width: 60%">
                                                </div>
                                                <div class="form-group" style="margin-left: 150px">
                                                    <label for="startDate">出发时间</label>
                                                    <input type="text" class="form-control" id="startDate" name="startDate" value="<?php echo ($data["startdate"]); ?>"
                                                           style="width: 60%">
                                                </div>
                                                <div class="form-group" style="margin-left: 150px">
                                                    <label for="finDate">到达时间</label>
                                                    <input type="text" class="form-control" id="finDate" name="finDate" value="<?php echo ($data["findate"]); ?>"
                                                           style="width: 60%">
                                                </div>
                                                <div class="form-group" style="margin-left: 150px">
                                                ...
                                                <div class="form-group" style="margin-left: 150px">
                                                    ...
                                                    <input type="text" class="form-control" id="type" name="type" value="<?php echo ($data["type"]); ?>"
                                                           style="width: 60%">
                                                </div>
