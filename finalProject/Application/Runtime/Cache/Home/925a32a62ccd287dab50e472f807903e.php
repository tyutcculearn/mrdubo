                        ...
                        <td>
                            <div id="head" class="img-responsive" alt="Responsive image">
                                ...
                                <a type="button" class="btn btn-primary btn-xs btn-link" data-toggle="modal"
                                   data-target="#<?php echo ($data["sheid"]); ?>"
                                   style="text-decoration: none;font-size: 15px;margin-left: -6px;margin-top: -5px;margin-bottom: -5px">
                                    修改旅行社
                                </a>
                                <!-- Modal -->
                                <div class="modal fade" id="<?php echo ($data["sheid"]); ?>" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content" style="color: #3c3c3c">
                                            ...
                                            <div>
                                                <form method="post" action="/airadmin/index.php/Home/Index/agencyupd">
                                                    <div class="form-group" style="margin-left: 150px; display: none">
                                                        <label for="sheid">编号</label>
                                                        <input type="text" class="form-control" id="sheid" name="sheid" value="<?php echo ($data["sheid"]); ?>"
                                                               style="width: 60%">
                                                    </div>
                                                    ...
                                                    <div class="form-group" style="margin-left: 150px  ">
                                                        ...
                                                        <input type="text" class="form-control" id="passwd" name="passwd" value="<?php echo ($data["passwd"]); ?>"
                                                               style="width: 60%">
                                                    </div>
                                                    <div class="form-group" style="margin-left: 150px">
                                                        <label for="sphone">联系电话</label>
                                                        <input type="text" class="form-control" id="sphone" name="sphone" value="<?php echo ($data["sphone"]); ?>"
                                                               style="width: 60%">
                                                    </div>
                                                    <div class="form-group" style="margin-left: 150px">
                                                        <label for="place">地址</label>
                                                        <input type="text" class="form-control" id="place" name="place" value="<?php echo ($data["place"]); ?>"
                                                               style="width: 60%">
                                                    </div>
